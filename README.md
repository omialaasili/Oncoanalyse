Ce projet vise à concevoir un outil numérique complet pour l’analyse des risques de
cancer, en s’appuyant sur trois types de données complémentaires : des mammographies,
des biopsies avec mesures morphologiques des tumeurs, ainsi que des données biométriques
...
il constitue une aide précieuse au diagnostic, en apportant des prédictions automatisées
fondées sur des données historiques, contribuant à une prise en charge plus rapide et plus
précise.
